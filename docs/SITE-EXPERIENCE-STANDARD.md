...
Theme 3.2.74 is verified live at `3.2.74+20260913-175607`, with both canonical
canaries reporting `LIVE_COHERENT`. Hero button and Quick Start panels load
existing settings. The 3.2.75 candidate adds the seven existing winner controls,
preserving the live 7200ms autoplay default and clearly explaining the latest
ceremony heading fallback. This candidate needs its own release and acceptance.
