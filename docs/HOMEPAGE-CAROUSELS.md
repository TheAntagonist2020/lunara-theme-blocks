...
| --- | --- | --- |
| Hero Carousel | Published reviews and Journal articles | One large featured story |
| Journal Carousel | Published Journal articles of any type | Three cards on desktop, two on tablet, one on phones |
...
An empty manual list hides its section. Unpublished or deleted selections stay
listed with a warning but are skipped on the homepage. One eligible story shows
as a static feature; missing artwork uses a Lunara placeholder. Visitors can
navigate with arrows, swipe or the keyboard and pause rotation. Reduced-motion
preferences stop automatic movement.

Revision History can restore a prior saved configuration, including the
presentation that existed before the first Apply. Old carousel-only controls
lead back to these panels after adoption.

Suggested first pass: choose the hero lineup, then check the latest Journal
stories. Publishing or revising an article remains a separate editorial action.
Lunara Method and the Oscars sections are outside these controls.
