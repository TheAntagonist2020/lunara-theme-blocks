...
async function openTestPage(browser, width) {
...
(async () => {
    ...
    process.stdout.write(JSON.stringify({ fixtureBytes, fixtureHash, aggregateBytes: 847152, aggregateHash: '6670f9bc1f11eb7c082e7c43e3f2ec66a2472d5131f3e3a935eb691415cfaeae', compressedAggregateBytes: staleAggregate.compressedBytes, compressedAggregateHash: staleAggregate.compressedHash, routeBytes, headBytes, exactAggregate: staleAggregate.exact, results }, null, 2) + '\n');
})().catch((error) => {
