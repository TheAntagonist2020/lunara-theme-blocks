...
Assert-True ($setup -match 'function\s+lunara_preload_home_text_fonts') 'The split loader must preload the Home text faces.'
Assert-True ($setup -match "TiemposText-Regular\.woff2") 'The Home text preload is missing Tiempos Text Regular.'
Assert-True ($setup -match "TiemposText-Bold\.woff2") 'The Home text preload is missing Tiempos Text Bold.'
