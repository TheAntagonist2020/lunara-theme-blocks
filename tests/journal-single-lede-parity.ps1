...
# Theme 3.2.61 — Journal single lede parity.
#
...
Assert-True ($style -match 'Version:\s*3\.2\.61') 'Journal lede parity must ship in Theme 3.2.61.'
...
Write-Host 'Theme 3.2.61 journal single lede parity contract passed: reviews keep the lede, journal paragraphs share one body clamp.'
