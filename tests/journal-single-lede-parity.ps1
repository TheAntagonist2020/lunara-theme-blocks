...
# Theme 3.2.59 — Journal single lede parity.
#
...
Write-Host 'Theme 3.2.59 journal single lede parity contract passed: reviews keep the lede, journal paragraphs share one body clamp.'
