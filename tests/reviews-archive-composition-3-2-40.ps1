...
$versionLine = (Read-ThemeFile 'style.css' | Select-String -Pattern 'Version:\s*3\.2\.57').Matches.Count
Assert-True ($versionLine -ge 1) 'Theme version must be 3.2.57.'

Write-Host 'Theme 3.2.57 Reviews Archive composition contract passed.'
