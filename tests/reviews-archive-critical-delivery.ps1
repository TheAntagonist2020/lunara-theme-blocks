...
Assert-True ($style -match '(?m)^Version:\s*3\.2\.65\s*$') 'Theme version must preserve the Reviews critical-delivery repair in 3.2.65.'
...
Write-Host "Theme 3.2.65 Reviews critical delivery contract passed: universal seed ${seedByteCount}B ($seedSha256); route CSS ${routeCssBytes}B; Boost fixture ${fixtureBytes}B."
