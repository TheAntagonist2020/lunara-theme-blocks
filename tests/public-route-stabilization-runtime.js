...
function htmlFor(route) {
    ...
    </style></head><body class="lunara-public-stabilization-fixture ${route.bodyClass}"><div class="site"><main id="canonical-main" class="site-main"><i class="test-box-sizing-sentinel" aria-hidden="true"></i><${tag} id="primary" class="${route.rootClass}" data-lunara-theme-version="3.2.74">${route.content}</${tag}></main></div></body></html>`;
}
