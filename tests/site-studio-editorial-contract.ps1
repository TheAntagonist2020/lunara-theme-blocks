...
foreach ($runtime in @('site-studio-legacy-snapshot-runtime.php', 'site-studio-footer-navigation-runtime.php', 'control-desk-editor-handoffs-runtime.php', 'generic-page-landmark-runtime.php', 'template-main-landmarks-runtime.php')) {
