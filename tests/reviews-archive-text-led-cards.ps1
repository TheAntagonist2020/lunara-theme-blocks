...
if ($style -notmatch '(?m)^Version:\s*3\.2\.62\s*$') {
    throw 'Theme version must preserve the mobile text-led card repair in 3.2.62.'
}
...
Write-Host 'Theme 3.2.62 Reviews mobile card legibility contract passed.'
