...
if ($style -notmatch '(?m)^Version:\s*3\.2\.77\s*$') {
    throw 'Theme version must preserve the mobile text-led card repair in 3.2.77.'
}
...
Write-Host 'Theme 3.2.77 Reviews mobile card legibility contract passed.'
