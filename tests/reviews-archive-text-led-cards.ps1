...
if ($style -notmatch '(?m)^Version:\s*3\.2\.68\s*$') {
    throw 'Theme version must preserve the mobile text-led card repair in 3.2.68.'
}
...
Write-Host 'Theme 3.2.68 Reviews mobile card legibility contract passed.'
