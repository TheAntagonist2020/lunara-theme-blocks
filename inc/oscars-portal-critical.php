...
#primary.lunara-oscars-portal .lunara-oscars-board-list{display:grid!important;gap:clamp(8px,.8vw,14px)!important;grid-template-columns:repeat(auto-fill,minmax(min(100%,190px),1fr))!important;list-style:none!important;margin:clamp(18px,2vw,28px) 0 0!important;padding:0!important}
...
#primary.lunara-oscars-portal .lunara-ceremony-winners-grid{display:grid!important;gap:clamp(10px,1vw,16px)!important;grid-template-columns:repeat(auto-fill,minmax(min(100%,200px),1fr))!important}
