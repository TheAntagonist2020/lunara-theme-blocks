<?php
/**
 * The Oscars data layer: everything the Oscars portal and the homepage's
 * Oscars sections read from the Academy database.
 *
 * Winner labels and links, winner and title visuals, the ceremony snapshot and
 * its winner map, the ceremony winner cards, the rotating ceremony showcase,
 * the database spotlight, the ledger story cards, the Oscar spotlight and the
 * deep cuts, plus the flush that clears their caches after a data import.
 *
 * Moved verbatim out of inc/home-sections.php in Theme 3.2.90. The portal is
 * the main consumer, and it no longer depends on a homepage module for its
 * data. Function names are unchanged, so every caller works as before.
 *
 * @package Lunara_Film
 */
...
/**
 * The Academy database plugin instance, or null when the plugin is inactive.
 */
