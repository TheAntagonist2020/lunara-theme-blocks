	...
	function lunara_site_studio_default_surfaces() {
		return array(
			'lunara-method' => array(
				...
				'preview_route'       => '/',
				'preview_query_arg'   => 'lunara_method_preview',
				'adapter_factory'     => 'lunara_site_studio_lunara_method_adapter',
				'state_schema_callback' => 'lunara_site_studio_lunara_method_state_schema',
			...
			'homepage-structure' => array(
				...
				'supports_preview'    => true,
				'preview_route'       => '/',
				'preview_query_arg'   => 'lunara_homepage_preview',
				'adapter_factory'     => 'lunara_site_studio_homepage_structure_adapter',
				'state_schema_callback' => 'lunara_site_studio_homepage_structure_state_schema',
				'admin_url'           => 'admin.php?page=lunara-site-studio&surface=homepage-structure',
				'dependency_callback' => 'lunara_site_studio_dependency_available',
				'status_callback'     => 'lunara_site_studio_status_ready',
				'danger_level'        => 'none',
				'sections'            => array( 'hero', 'latest-reviews', 'pairing-desk', 'dispatch', 'oscar-picks', 'oscar-facts' ),
			...
			'global-design' => array(
				...
				'description'         => __( 'Control the sitewide palette and typography roles in plain language.', 'lunara-film' ),
				'aliases'             => array( 'brand', 'palette', 'colors', 'typography', 'fonts' ),
				'owner'               => 'theme:global-design',
				'kind'                => 'presentation',
				'capability'          => 'edit_theme_options',
				'supports_preview'    => true,
				'preview_route'       => '/',
				'preview_query_arg'   => 'lunara_global_design_preview',
				'adapter_factory'     => 'lunara_site_studio_global_design_adapter',
				'state_schema_callback' => 'lunara_site_studio_global_design_state_schema',
				'admin_url'           => 'admin.php?page=lunara-site-studio&surface=global-design',
				'dependency_callback' => 'lunara_site_studio_dependency_available',
				'status_callback'     => 'lunara_site_studio_status_ready',
				'danger_level'        => 'none',
				'sections'            => array( 'colors', 'typography' ),
			...
			'journal-single' => array(
				'id'                    => 'journal-single',
				'group'                 => __( 'Editorial', 'lunara-film' ),
				'label'                 => __( 'Journal Article', 'lunara-film' ),
				'description'           => __( 'Control Journal article headlines, bylines, dates, reading time and hero image framing.', 'lunara-film' ),
				'aliases'               => array( 'journal article', 'article layout', 'headline', 'byline', 'image framing' ),
				'owner'                 => 'theme:journal-single',
				'kind'                  => 'presentation',
				'capability'            => 'edit_theme_options',
				'supports_preview'      => true,
				'preview_route'         => function_exists( 'lunara_site_studio_journal_single_preview_route' ) ? lunara_site_studio_journal_single_preview_route() : '/journal/',
				'preview_query_arg'     => 'lunara_journal_single_preview',
				'preview_params'        => array(),
				'adapter_factory'       => 'lunara_site_studio_journal_single_adapter',
				'state_schema_callback' => 'lunara_site_studio_journal_single_state_schema',
				'admin_url'             => 'admin.php?page=lunara-site-studio&surface=journal-single',
				'dependency_callback'   => 'lunara_site_studio_journal_single_dependency',
				'status_callback'       => 'lunara_site_studio_status_ready',
				'danger_level'          => 'none',
				'sections'              => array( 'hero', 'article', 'gallery' ),
				'classic_url'           => 'edit.php?post_type=journal',
				'renderer'              => '',
			),
			'utility-search' => array(
				...
				'description'           => __( 'Control Search copy, results and shared Search/404 appearance. Preview the search start or sample results.', 'lunara-film' ),
				'aliases'               => array( 'search', 'results', 'empty search', 'recovery appearance', 'utility' ),
			...
			'utility-404' => array(
				'id'                    => 'utility-404',
				'group'                 => __( 'Utility', 'lunara-film' ),
				'label'                 => __( '404 Recovery', 'lunara-film' ),
				'description'           => __( 'Edit the missing-page explanation, guidance and return destinations, with a private 404 preview.', 'lunara-film' ),
				'aliases'               => array( '404', 'not found', 'missing page', 'recovery', 'return links' ),
				'owner'                 => 'theme:utility-404',
				'kind'                  => 'presentation',
				'capability'            => 'edit_theme_options',
				'supports_preview'      => true,
				'preview_route'         => '/definitely-not-a-real-lunara-route/',
				'preview_query_arg'     => 'lunara_404_preview',
				'preview_params'        => array(),
				'adapter_factory'       => 'lunara_site_studio_utility_404_adapter',
				'state_schema_callback' => 'lunara_site_studio_utility_404_state_schema',
				'admin_url'             => 'admin.php?page=lunara-site-studio&surface=utility-404',
				'dependency_callback'   => 'lunara_site_studio_dependency_available',
				'status_callback'       => 'lunara_site_studio_status_ready',
				'danger_level'          => 'none',
				'sections'              => array( 'search-command', 'recovery' ),
				'classic_url'           => 'admin.php?page=lunara-site-studio&surface=utility-search',
				'renderer'              => '',
			),
			'site-footer' => array(
				'id'                    => 'site-footer',
				...
				'description'           => __( 'Control the footer logo, closing line, headings, ordered navigation links and copyright name.', 'lunara-film' ),
			...
			'debrief-method' => array(
				...
				'capability'            => 'edit_theme_options',
				'supports_preview'      => true,
				'preview_route'         => function_exists( 'lunara_site_studio_debrief_method_preview_route' ) ? lunara_site_studio_debrief_method_preview_route() : '/debrief/',
				'preview_query_arg'     => 'lunara_debrief_method_preview',
				'preview_params'        => array(),
				'adapter_factory'       => 'lunara_site_studio_debrief_method_adapter',
				'state_schema_callback' => 'lunara_site_studio_debrief_method_state_schema',
				'admin_url'             => 'admin.php?page=lunara-site-studio&surface=debrief-method',
