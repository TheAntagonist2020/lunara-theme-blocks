...
if ( ! function_exists( 'lunara_render_review_archive_shell' ) ) {
    function lunara_render_review_archive_shell( $args = array() ) {
        ...
        <main id="primary" class="<?php echo esc_attr( $classes ); ?>">
            ...
            <?php endif; ?>
            <?php if ( $show_hero ) : ?>
            <section class="lunara-home-section lunara-archive-hero lunara-review-archive-hero lunara-review-archive-slot-hero" data-lunara-section="hero" style="order:<?php echo esc_attr( (string) $lane_orders['hero'] ); ?>;">
            ...
            <section class="lunara-home-section lunara-review-archive-utility lunara-review-archive-slot-utility" data-lunara-section="utility" style="order:<?php echo esc_attr( (string) $lane_orders['utility'] ); ?>;">
            ...
            <?php if ( $show_grid ) : ?>
            <section class="lunara-home-section lunara-review-archive-shell lunara-review-archive-slot-grid" data-lunara-section="grid" style="order:<?php echo esc_attr( (string) $lane_orders['grid'] ); ?>;">
                <?php if ( $lead_post instanceof WP_Post ) : ?>
            ...
            <?php if ( $show_grid && $show_pagination && $has_posts && ! empty( $args['pagination'] ) ) : ?>
                    <div class="lunara-archive-pagination lunara-review-archive-slot-pagination" data-lunara-section="pagination" style="order:<?php echo esc_attr( (string) $lane_orders['pagination'] ); ?>;">
                        <?php echo wp_kses_post( $args['pagination'] ); ?>
                    </div>
            ...
            <?php if ( $show_pairing_desk ) : ?>
                <div class="lunara-review-archive-slot-pairing-desk" data-lunara-section="pairing-desk" style="order:<?php echo esc_attr( (string) $lane_orders['pairing-desk'] ); ?>;">
