...
function lunara_control_desk_get_system_status() {
    ...
    return array(
        ...
        array(
            ...
            'state' => '2.7.35' === $aat_version ? 'ready' : ( $aat_version ? 'weak' : 'needs' ),
...
function lunara_control_desk_get_source_status() {
    return array(
        ...
        array(
            ...
            'state' => 'ready',
            'note'  => 'feat/ceremony-depth-thesis @ c793aa8; person visual integrity states verified; Deployer for Git Pro is inactive; original source folder has pre-existing SQL drift and was not the deploy source.',
        ),
        array(
...
function lunara_control_desk_get_source_control_status() {
    return array(
        ...
        array(
            ...
            'value' => 'feat/ceremony-depth-thesis @ c793aa8',
            'state' => 'ready',
