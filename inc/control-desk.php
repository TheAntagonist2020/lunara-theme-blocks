...
function lunara_control_desk_get_system_status() {
    ...
    return array(
        ...
        array(
            ...
            'state' => '2.7.69' === $aat_version ? 'ready' : ( $aat_version ? 'weak' : 'needs' ),
...
function lunara_control_desk_get_source_status() {
    return array(
        ...
        array(
            ...
            'state' => 'ready',
            'note'  => 'feat/ceremony-depth-thesis @ a447ea7; Sound Recording and legacy Song Score / Adaptation Score routes now use the premium dossier system with polished category, music, and ceremony breadcrumbs for Oscars 2.7.69.',
        ),
        array(
