...
function lunara_control_desk_get_system_status() {
    ...
    return array(
        ...
        array(
            ...
            'state' => '2.7.86' === $aat_version ? 'ready' : ( $aat_version ? 'weak' : 'needs' ),
...
function lunara_control_desk_get_source_status() {
    return array(
        ...
        array(
            ...
            'state' => 'ready',
            'note'  => 'feat/ceremony-depth-thesis @ 7f066bc; title/person profile reader paths for Oscars 2.7.86.',
        ),
        array(
...
function lunara_control_desk_get_source_control_status() {
    return array(
        ...
        array(
            ...
            'value' => 'feat/ceremony-depth-thesis @ 7f066bc',
            'state' => 'ready',
