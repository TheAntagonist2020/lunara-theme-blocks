...
function lunara_control_desk_get_system_status() {
    ...
    return array(
        ...
        array(
            ...
            'state' => '2.7.72' === $aat_version ? 'ready' : ( $aat_version ? 'weak' : 'needs' ),
...
function lunara_control_desk_get_source_status() {
    return array(
        ...
        array(
            ...
            'state' => 'ready',
            'note'  => 'feat/ceremony-depth-thesis @ 106408a; Assistant Director and Dance Direction now use the premium dossier system for Oscars 2.7.72.',
        ),
        array(
