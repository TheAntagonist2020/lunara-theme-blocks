...
function lunara_control_desk_get_system_status() {
    ...
    return array(
        ...
        array(
            ...
            'state' => '2.7.77' === $aat_version ? 'ready' : ( $aat_version ? 'weak' : 'needs' ),
...
function lunara_control_desk_get_source_status() {
    return array(
        ...
        array(
            ...
            'state' => 'ready',
            'note'  => 'feat/ceremony-depth-thesis @ b6f7fdb; Oscar category era browsers now fill verified nominee title visuals after winner visuals for Oscars 2.7.77.',
        ),
        array(
