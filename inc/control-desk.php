...
function lunara_control_desk_get_system_status() {
    ...
    return array(
        ...
        array(
            ...
            'state' => '2.7.84' === $aat_version ? 'ready' : ( $aat_version ? 'weak' : 'needs' ),
...
function lunara_control_desk_get_source_status() {
    return array(
        ...
        array(
            ...
            'state' => 'ready',
            'note'  => 'feat/ceremony-depth-thesis @ a5792ac; ceremony highlights exit lane for Oscars 2.7.84.',
        ),
        array(
...
function lunara_control_desk_get_source_control_status() {
    return array(
        ...
        array(
            ...
            'value' => 'feat/ceremony-depth-thesis @ a5792ac',
            'state' => 'ready',
