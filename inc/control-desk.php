...
function lunara_control_desk_get_system_status() {
    ...
    return array(
        ...
        array(
            ...
            'state' => '2.7.71' === $aat_version ? 'ready' : ( $aat_version ? 'weak' : 'needs' ),
...
function lunara_control_desk_get_source_status() {
    return array(
        ...
        array(
            ...
            'state' => 'ready',
            'note'  => 'feat/ceremony-depth-thesis @ 8da362c; early Short Subject Comedy, Novelty, Color, One-reel, and Two-reel routes now use the premium dossier system for Oscars 2.7.71.',
        ),
        array(
