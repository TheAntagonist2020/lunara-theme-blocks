...
function lunara_render_oscars_portal_markup() {
    ...
    if ( '' !== $hero_backdrop_url ) {
        // 3.2.61: the backdrop is meant to be seen. Dark enough on the left for
...
if ( ! function_exists( 'lunara_render_oscars_prediction_board' ) ) {
	...
	function lunara_render_oscars_prediction_board() {
		...
		// 3.2.61: the poster wall. Art per pick (the pick's own image, then a
...
/* ---------------------------------------------------------------------------
 * Oscars portal, Theme 3.2.61: the poster wall's art and the backdrop warmer.
 *
