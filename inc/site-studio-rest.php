...
if ( ! function_exists( 'lunara_site_studio_safe_validation_fields' ) ) {
	...
	function lunara_site_studio_safe_validation_fields( $error ) {
		$allowed = array(
			'title', 'kicker', 'colors', 'color_gold', 'color_gold_light', 'color_bg_primary', 'color_bg_secondary', 'color_text', 'color_text_muted', 'fonts', 'font_body', 'font_display', 'font_signature', 'font_glamour', 'font_label', 'copy', 'review_id', 'backdrop_id', 'review_mode', 'backdrop', 'preset', 'desktop_order', 'mobile_order', 'visibility', 'front_page', 'deck', 'supporting_copy', 'section_order', 'section_visibility', 'presentation', 'identity', 'geometry', 'labels', 'gallery', 'retention', 'lead_mode', 'lead_id', 'lane_mode', 'curated_ids', 'item_count',
			...
			'presentation.dossier_preset', 'presentation.dossier_density', 'presentation.ceremony_rhythm', 'presentation.major_race_prominence', 'presentation.profile_scale', 'presentation.profile_media_treatment', 'presentation.writeup_prominence', 'presentation.related_reviews_treatment', 'presentation.title_image_focus', 'presentation.dossier_section_gap', 'presentation.dossier_card_min', 'presentation.profile_media_width', 'presentation.profile_media_height', 'presentation.related_reviews_count',
			...
			'hero', 'metadata', 'hero.title_size', 'hero.image_fit', 'hero.image_position_x', 'hero.image_position_y', 'metadata.show_byline', 'metadata.show_date', 'metadata.show_reading_time',
