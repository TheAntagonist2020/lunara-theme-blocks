...
if ( ! function_exists( 'lunara_journal_archive_critical_css' ) ) {
	...
	function lunara_journal_archive_critical_css() {
		$css = <<<'CSS'
#primary.lunara-journal-archive-page{box-sizing:border-box;display:flex!important;flex-direction:column!important;gap:var(--lunara-journal-archive-section-gap,38px)!important;margin-inline:auto!important;max-width:1180px!important;min-width:0!important;padding:0 clamp(16px,4vw,40px) 80px!important;width:min(1180px,calc(100vw - 40px))!important}
...
#primary.lunara-journal-archive-page .lunara-journal-archive-filters{align-items:center;display:flex!important;flex-wrap:wrap!important;gap:10px!important;margin:0!important;padding:10px!important;width:100%!important}
