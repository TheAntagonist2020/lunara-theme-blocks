...
if ( ! function_exists( 'lunara_site_studio_render_oscars_portal_inspector' ) ) {
	function lunara_site_studio_render_oscars_portal_inspector( $state, $revisions ) {
		lunara_site_studio_render_details_open( 'essentials', __( 'Portal copy', 'lunara-film' ), true, array( 'hero', 'doors', 'spotlights', 'titles', 'research', 'linked-reviews', 'deep-cuts' ) );
		...
		lunara_site_studio_render_details_open( 'fine-tune', __( 'Presentation', 'lunara-film' ), false, array( 'board', 'winners', 'rotating-winners' ) );
...
if ( ! function_exists( 'lunara_site_studio_render_method_inspector' ) ) {
	function lunara_site_studio_render_method_inspector( $state, $revisions, $classic_url ) {
		...
		lunara_site_studio_render_details_open( 'fine-tune', __( 'Fine Tune', 'lunara-film' ) );
...
if ( ! function_exists( 'lunara_render_site_studio_page' ) ) {
	function lunara_render_site_studio_page() {
		...
		<div class="wrap lunara-site-studio" data-lunara-site-studio data-surface="<?php echo esc_attr( $active_id ); ?>" data-workspace-state="recovery" data-dirty="false">
			<header class="lunara-site-studio-header"><div><p class="lunara-site-studio-kicker"><?php esc_html_e( 'Lunara · Visual Site Map', 'lunara-film' ); ?></p><h1><?php esc_html_e( 'Site Studio', 'lunara-film' ); ?></h1><p><?php esc_html_e( 'Choose a surface, inspect its live state, and explicitly preview or apply changes.', 'lunara-film' ); ?></p></div></header>
