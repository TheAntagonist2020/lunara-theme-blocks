...
if ( ! function_exists( 'lunara_enqueue_site_studio_assets' ) ) {
	function lunara_enqueue_site_studio_assets( $hook ) {
		...
		foreach ( array( 'style' => 'assets/css/lunara-site-studio.css', 'script' => 'assets/js/lunara-site-studio.js' ) as $kind => $relative ) {
			if ( 'script' === $kind && in_array( $surface_id, array( 'hero-carousel', 'journal-carousel' ), true ) ) { $relative = 'assets/js/lunara-site-studio-carousels.js'; }
		...
		if ( in_array( $surface_id, array( 'lunara-method', 'hero-carousel', 'journal-carousel' ), true ) ) { wp_enqueue_media(); }
		if ( in_array( $surface_id, array( 'hero-carousel', 'journal-carousel' ), true ) ) { $asset = lunara_resolve_theme_asset( 'assets/css/lunara-site-studio-carousels.css' ); wp_enqueue_style( 'lunara-site-studio-carousels', $asset['uri'], array( 'lunara-site-studio' ), lunara_theme_asset_version( $asset['path'] ) ); }
	}
