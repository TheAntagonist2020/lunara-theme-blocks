...
if ( ! function_exists( 'lunara_site_studio_workspace_editable_surfaces' ) ) {
	...
	function lunara_site_studio_workspace_editable_surfaces() {
		return array( 'global-design', 'homepage-structure', 'lunara-method', 'reviews-archive', 'review-single', 'journal-archive', 'utility-search', 'site-footer', 'hero-carousel', 'journal-carousel' );
	}
}
...
if ( ! function_exists( 'lunara_enqueue_site_studio_assets' ) ) {
	function lunara_enqueue_site_studio_assets( $hook ) {
		...
		$uses_ordered_list = in_array( $surface_id, array( 'homepage-structure', 'reviews-archive', 'journal-archive' ), true );
